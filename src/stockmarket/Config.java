...
public class Config {
	...
	public static final int HIDDEN1_COUNT = 2;
	public static final int HIDDEN2_COUNT = 6; 
	//how many data points per day
	public static final int INPUT_WINDOW = 52;
	//number of inputs
	public static final int PREDICT_WINDOW = 1;
	public static final TickerSymbol TICKER = new TickerSymbol("AAAP");
}
